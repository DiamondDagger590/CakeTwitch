package relampagorojo93.caketwitch.spigotcommands;
...
public class CommandsUtils {
    public static Command registerCommand(JavaPlugin plugin, relampagorojo93.caketwitch.spigotcommands.objects.Command cmd) {
        if (plugin.getCommand(cmd.getCommand()) == null) {
            ...
            command.setTabCompleter(new relampagorojo93.caketwitch.spigotcommands.objects.Command.CommandTabCompleter(cmd));
            try {
