package relampagorojo93.caketwitch.spigotthreads.objects;

import relampagorojo93.caketwitch.spigotthreads.exceptions.AlreadyStartedException;
import relampagorojo93.caketwitch.spigotthreads.exceptions.AlreadyStoppedException;
...
public class Thread implements AutoCloseable {
    ...
    public void start() throws AlreadyStartedException {
        if (!isStarted()) {
            (thread = new java.lang.Thread(threadrunnable)).start();
        }
        else {
